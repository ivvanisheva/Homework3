...
public class Task4_PersonCharacteristics {
	...
	public static void main(String[] args) {
		...
		System.out.println("Now please enter <първо_име>;<последно_име>;<пол>;<година_на_раждане>;<тегло>;<височина>;<професия>;<оценка1>;<оценка2>;<оценка3>; <оценка4>  ");
		for (int i = 0; i < n; i++) {
			...
			result += String.format(" %s weight is %.1f and %s is %d cm tall.", hisOrHer, weight, heOrShe.toLowerCase(),
					height);
